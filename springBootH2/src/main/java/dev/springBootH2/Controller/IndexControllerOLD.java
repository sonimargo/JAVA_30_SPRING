...
@Controller
public class IndexControllerOLD {
	/*
	 * @RequestMapping(value = { "/biblioteca" }) public String inicioHome(Locale
	 * locale,Model model) { Date date = new Date(); DateFormat dateFormat =
	 ...
	 * 
	 * @RequestMapping(value = { "/*" }) public String paginaError(Locale
	 * locale,Model model) {
	 * 
